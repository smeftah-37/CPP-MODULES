...
ClapTrap::ClapTrap()
{
    std::cout << "Default Constructer ClapTrap called" << std::endl;
    this->name = "Unknown";
    hitPoint = 10;
    energyPoint = 10;
    Dmage =0;
...
{
    std::cout << "parametrise Constructer ClapTrap called" << std:: endl;
    this->name = name;
    hitPoint = 10;
    energyPoint = 10;
    Dmage =0;
...
void ClapTrap::beRepaired(unsigned int amount)
{
    if(energyPoint >0)
    {
        ...
        std::cout << "you dont have enough energyPoint or hit point" << std::endl;
